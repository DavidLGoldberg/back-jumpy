...
var author$project$StateMachine$init = function (flags) {
	return _Utils_Tuple2(
		{isJumping: false, positions: _List_Nil},
				...
				return _Utils_Tuple2(
					A2(
						...
						_Utils_update(
							model,
							{
								positions: A2(elm$core$List$cons, position, model.positions)
							})),
					elm$core$Platform$Cmd$none);
			case 'RequestBack':
									...
									A2(
										...
										elm$core$List$head(
											elm$core$List$reverse(
												A2(elm$core$List$take, 2, model.positions)))))),
...
var author$project$StateMachine$main = elm$core$Platform$worker(
	{
		...
		subscriptions: function (model) {
			return elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						author$project$StateMachine$requestRegisterPosition(author$project$StateMachine$RequestRegisterPosition),
						author$project$StateMachine$requestBack(
						elm$core$Basics$always(author$project$StateMachine$RequestBack)),
						author$project$StateMachine$requestForward(
